			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$src('img/img.jpeg'),
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Isak Skoog')
							])),
						A2(
						$elm$html$Html$p,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('tagline')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('21yo · CS Student · Quant Dev @ Silverbeard Engineering')
							])),
						A2(
						$elm$html$Html$p,
						_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('https://github.com/isak-sk/epidemic-sim'),
								$elm$html$Html$Attributes$class('proj-link')
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('https://github.com/isak-sk')
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('https://linkedin.com/in/isakskoog')
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('mailto:skoog.isak@gmail.com')
							]),
						_List_fromArray(
							[
...
var $author$project$HomePage$main = $elm$browser$Browser$sandbox(
	{aB: $author$project$HomePage$init, aP: $author$project$HomePage$update, aQ: $author$project$HomePage$view});
